...
class Direktt_CF7_Github_Updater
{
    private $version;
    public $cache_key;
    public $cache_allowed;

    public function __construct($version, $cache_allowed = true)
    {
        $this->version = $version;
        $this->cache_key     = 'direktt_cf7_updater';
    ...
    public function get_github_update_info()
    {
        ...
        if ( false === $remote_info || ! $this->cache_allowed ) {
            $response = wp_remote_get('https://raw.githubusercontent.com/direktt/direktt-cf7/master/info.json');
    ...
    public function github_update($transient)
    {
        ...
        $plugin_file_path = WP_PLUGIN_DIR . '/direktt-cf7/direktt-cf7.php';
